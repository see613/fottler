<template>
    <loadable-event-view-container :event-id="openedEventId"
...
<script>
    ...
    const { mapState, mapGetters, mapActions } = createNamespacedHelpers('myMessages');

    export default {
        name: 'MyMessagesEventView',
